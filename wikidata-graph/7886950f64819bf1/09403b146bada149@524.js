...
<p style="background: #fffced; box-sizing: border-box; padding: 10px 20px; font-style: italic;">**Update May 2023:** This notebook has been deprecated and is no longer maintained; please see the newer [D3 bar chart example](/@d3/bar-chart/2?intent=fork) and [Observable Plot bar chart example](/@observablehq/plot-vertical-bar-chart?intent=fork).</p>
